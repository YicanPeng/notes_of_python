...
""" 1.基础语法,注释 """
""" 注释只能在句尾使用关键字和关键符 """
""" 除关键字外,python变量赋值就是声明,字典列表集合赋值为空,就是元素不定的变量 """
""" 引用模块时添加别名,简化语句 """
# import keyword as k
...
""" 数据类型 """
""" python有6种数据类型:数字,字符串,元组,列表,字典,集合;其中数字,字符串,元组是不可变数据类型
...
""" 字符串string,列表list,元组tuple都属于序列,都可以用索引数字进行截取和索引,索引从0计数
   ...
   如需索引到最后一位,则尾标留空 """
""" 列表标识符是中括号[] """
""" 元组标识符是小括号(),空元祖()内无需元素,一个元素的元组需要在元素后加逗号,如tup002_1 """
str002="runoob";lis002=["a",1,3+2j];tup002=(str002,lis002,0);tup002_1=("a",)
# print(str002[0::2]);print(lis002[1:-1]);print(tup002[1]),print(tup002_1)
print("\a")
...
""" 集合set和字典dictionary的标识符都是大括号{},其中空集合只能用set()赋值,而{}赋值的是空字典
   字典的元素是由(键:值)成对组成的2元素元组,用键作为索引,键必须是唯一的,而且必须是不可变数据类型 """
...
""" 例3dict函数成对赋值,这种赋值,键必须是字符串或元组(数字无法被赋值) """
...
# print(lis004_5_3)
# print(dic004_5)
""" zip函数用于把两个列表配对成元组作为元素的一维列表,其反用法如下 """
